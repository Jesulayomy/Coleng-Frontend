...
const Uploader = ({ close }) => {
    ...
    return (
        <div className="focus:outline-none transition-all duration-700 fade-in-out fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 p-10 w-[50%] md:w-[90%] border-2 md:p-4 rounded-lg shadow-lg shadow-slate-500 bg-white">
            <div className="">
                <button
                    type="button"

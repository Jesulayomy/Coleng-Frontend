        ...
        <>
          <div className='p-3' id='receipt-container'>
            ...
            <div className='bg-gray-200'>
              ...
              <div className='grid grid-cols-2 items-center justify-center text-center tt'>
                <p className='bg-gray-300'>{data.createdAt}</p>
                <p className='bg-primary1 text-white'>{data.ref}</p>
              </div>
            </div>
          ...
          <button
            className='border-primary1 border-2 py-3 px-16 md:w-fit m-auto w-fit flex items-center justify-center rounded-md text-primary1 my-5 hover:bg-primary1 hover:text-white transition-all'
            onClick={downloadPDF}
          >
            Download PDF
          </button>
